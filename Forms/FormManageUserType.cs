...
{
    public partial class FormManageUserType : Form
    {
        public FormManageUserType()
        {
            InitializeComponent();
        }
        ...
        private void loadTypes()
        {
            ...
            Dao dao = new Dao();
            dao.connect();
            string sql = $"select * from Table_UserType";
        ...
        private void FormManageUserType_Load(object sender, EventArgs e)
        {
            loadTypes();
            if (dgv.Rows.Count == 1)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Dao dao = new Dao();
            dao.connect();
            string sql = $"select * from Table_UserType where TypeID like '%{key}%' or Type like '%{key}%' ";
            SqlDataReader reader = dao.read(sql);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Dao dao = new Dao();
            dao.connect();
            string sql = $"delete Table_UserType where TypeID = '{lblID.Text}'";
        ...
        {
            FormAddUserType form = new FormAddUserType();
            form.ShowDialog();
        }

        private void button6_Click(object sender, EventArgs e)
        {
            FormUpdateUserType form = new FormUpdateUserType(); 
            form.ShowDialog();
        }
