...
namespace BookManageSystem
{
    public partial class FormAddUserType : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Dao dao = new Dao();
            dao.connect();
            string sqlCheck = $"SELECT TypeID FROM Table_UserType WHERE TypeID = '{txttypeID.Text}'";
            ...
            {
                string sql = $"insert into Table_UserType values ('{txttypeID.Text}','{txtTypeName.Text}')";
                try
                {
